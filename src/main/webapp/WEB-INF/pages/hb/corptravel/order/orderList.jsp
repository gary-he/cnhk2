    ...
    <table border="0" cellspacing="0" cellpadding="0" class="table table-hover table-striped font12 table-bordered v-align-top" >
      ...
      <tr>
        ...
        <td><div class="startbox">
            ...
            <div class="startcity"><span>三亚</span> 凤凰国际机场<br/>
              2015-12-20&nbsp;&nbsp;11:45:00</div>
          </div></td>
        <td><div class="startbox">
          
          <div class="startcity"><span>哈尔滨</span> 太平国际机场<br/>
            2015-12-20&nbsp;&nbsp;14:45:00</div>
        </div></td>
        <td>1350.00</td>
        <td>新订单</td>
        <td><a href="orderInfo.html">【查看详情】</a><br>
          <a href="#" class="quxiao">【取消订单】</a><br>
          <a href="../pay/payment.html" target="_blank" >【立即支付】</a></td>
      </tr>
      <tr>
        <td>2016-01-14 <br>
          09:20</td>
